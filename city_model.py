...
class CityModel(mesa.Model):     
    def __init__(self, agents, time):
        ...
        self.driverType = 5 # Solo se modifica segun el driver de cada quien
    ...
    def createDriver(self) -> None:
        ...
        #
        typeToBe = random.randint(1,4)
        self.addAgent(DriverAgent(self.next_id(), self, typeToBe), row, col)
